...
import 'package:api_callig3/Login%20Page/authentication.dart';
import 'package:api_callig3/model/checkbox.dart';
      ...
      builder: (context, change, child) => Scaffold(
        appBar: AppBar(
          title: change.isselected
              ...
              : Text('Login Page',
                  style: TextStyle(
                      fontFamily: 'rrr', fontSize: 28, color: Colors.grey)),
          elevation: 0,
            ...
            children: [
              ...
              MaterialButton(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                      color:
                          change.isselected ? Colors.blueGrey : Colors.indigo,
